...
private:
	...
	static bool addConeWithLargestScaleFactor(VertexData<uint8_t>& isCone,
											  const DenseMatrix u,
	...
	static bool useCpmsStrategy(int S, VertexData<uint8_t>& isCone,
	...
	static bool useCetmStrategy(int S, VertexData<uint8_t>& isCone,
								DenseMatrix& C, const DenseMatrix& K,
